...
- P08 - Use the stored state management actions at core/stored_state_management/stored_state.py to store state on disk. This keeps stored state within the stored_state directory, which makes it easier for users to keep track of and git ignore.