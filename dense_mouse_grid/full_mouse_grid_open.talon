...
^one$:
    user.full_grid_input_partial(1)

^knee$:
    user.full_grid_input_partial(2)

^three$:
    user.full_grid_input_partial(3)

^four$:
    user.full_grid_input_partial(4)

^five$:
    user.full_grid_input_partial(5)

^six$:
    user.full_grid_input_partial(6)

^seven$:
    user.full_grid_input_partial(7)

^eight$:
    user.full_grid_input_partial(8)

^nine$:
    user.full_grid_input_partial(9)

^ten$:
    user.full_grid_input_partial(10)
