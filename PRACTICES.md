...
- You are implementing support for a multistep text insertion process that would be easier to complete with a single snippet than with separate commands that have to be memorized for different parts of the process.
