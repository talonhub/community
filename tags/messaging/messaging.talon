...
-
# Navigation
last (workspace | server): user.messaging_workspace_previous()
...
channel (up | next): user.messaging_channel_previous()
channel (down | last): user.messaging_channel_next()
([channel] unread last | gopreev): user.messaging_unread_previous()
([channel] unread next | goneck): user.messaging_unread_next()
search: user.messaging_open_search()
