...
# Navigation
<user.spatial_previous_next> (workspace | server):
    user.messaging_workspace_go(spatial_previous_next)
...
[channel] unread <user.spatial_previous_next>:
    user.messaging_unread_go(spatial_previous_next)
