...
change label: key(l)
right comment: key(r)
<user.spatial_previous_next> [unresolved] discussion: user.key_spatial_previous_next(spatial_previous_next, "p", "n")
<user.spatial_previous_next> file: user.key_spatial_previous_next(spatial_previous_next, "[", "]")
