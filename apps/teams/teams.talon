...
[go] [to] <user.spatial_previous_next> [list] item: user.key_spatial_previous_next(spatial_previous_next, "alt-up", "alt-down")
move [selected] team up: key(ctrl-shift-up)
move [selected] team down: key(ctrl-shift-down)
[go] [to] <user.spatial_previous_next> section: user.key_spatial_previous_next(spatial_previous_next, "ctrl-shift-f6", "ctrl-f6")
...
go to <user.spatial_previous_next> (day | week): user.key_spatial_previous_next(spatial_previous_next, "ctrl-alt-left", "ctrl-alt-right")
