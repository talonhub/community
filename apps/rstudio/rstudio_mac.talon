...
run <user.spatial_previous_next> chunk[s]: user.key_spatial_previous_next(spatial_previous_next, "cmd-alt-p", "cmd-alt-n")
...
find <user.spatial_previous_next>: user.key_spatial_previous_next(spatial_previous_next, "cmd-shift-g", "cmd-g")
...
go to <user.spatial_previous_next> tab: user.key_spatial_previous_next(spatial_previous_next, "ctrl-f11", "ctrl-f12")
...
help that: key("f1")
define that: key("f2")
<user.spatial_previous_next> plot: user.key_spatial_previous_next(spatial_previous_next, "cmd-alt-f11", "cmd-alt-f12")
