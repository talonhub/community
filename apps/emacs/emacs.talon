...
buffer (previous | prev): user.emacs("previous-buffer")
...
(previous | prev) error | error (previous | prev): user.emacs("previous-error")
...
merge (previous | prev): user.emacs("smerge-prev")
...
outline (previous | prev) [visible heading]:
