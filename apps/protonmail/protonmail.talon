...
## Navigation
<user.spatial_previous_next> message: user.key_spatial_previous_next(spatial_previous_next, "up", "down")
...
# Contacts
## Contact List
<user.spatial_previous_next> contact: user.key_spatial_previous_next(spatial_previous_next, "up", "down")
