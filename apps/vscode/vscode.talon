...
problem (previous | prev): user.vscode("editor.action.marker.prevInFiles")
...
go (previous | prev) mark: user.vscode("bookmarks.jumpToPrevious")
...
change (previous | prev): key(shift-alt-f5)
...
terminal (previous | prev): user.vscode("workbench.action.terminal.focusPrevious")
...
cell (previous | prev): user.vscode("notebook.focusPreviousEditor")
