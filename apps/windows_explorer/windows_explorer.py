...
def check_if_element_strictly_matches(element: windows.ax.Element, **kw) -> bool:
    ...
    Example:
        ...
        element_matches: bool = check_if_element_matches(element, name=channel_element_name, control_type="Group")
        ```
...
def first_matching_child(element: windows.ax.Element, **kw) -> windows.ax.Element | None:
    ...
    Example:
        ```python
        child = first_matching_child_ma(element, name="Channels", control_type="Group")
        ```
