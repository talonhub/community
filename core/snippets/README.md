...
- Snippet bodies without tab characters use leading white space as indentation. In this case, the smallest leading sequence of whitespace characters from a snippet body's lines represents a single level of indentation. You must therefore escape leading spaces to treat them as literal spaces in a snippet body that has no tab characters.
