...
mod.list("edit_modifier_repeatable", desc="Modifiers for the edit command that are repeatable")
...
@mod.capture(rule="({user.edit_modifier}) | ([<number_small>] {user.edit_modifier_repeatable})")
