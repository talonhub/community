...
@mod.capture(
    rule="({user.vocabulary} | {user.punctuation} | {user.prose_snippets} | <phrase> | <user.number_prose_prefixed> | <user.prose_modifier>)+"
)
def prose(m) -> str:
...
@mod.capture(
    rule="({user.vocabulary} | {user.punctuation} | {user.prose_snippets} | <phrase> | <user.number_prose_prefixed>)+"
)
def raw_prose(m) -> str:
