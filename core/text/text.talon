...
{user.prose_formatter} <user.prose>$: user.dictation_insert(prose, prose_formatter)
{user.prose_formatter} <user.prose> over: user.dictation_insert(prose, prose_formatter)
