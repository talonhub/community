...
def get_previous_size(path: str) -> int:
	...
	with open(path, "r") as f:
		...
		try:
			...
			raise ValueError(f"Could not parse the first line of the file responsible for tracking the previous size of the breaking changes file as an integer: {line_text}")
		return size
