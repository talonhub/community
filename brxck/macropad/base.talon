...
key(cmd-shift-alt-ctrl-x): speech.disable()

key(cmd-shift-alt-ctrl-y): speech.enable()

key(cmd-shift-alt-ctrl-z:down): user.speech_toggle()

key(cmd-shift-alt-ctrl-z:up): user.speech_toggle()
...
key(cmd-shift-alt-ctrl-8): user.switcher_focus_or_launch("iTerm2")

key(cmd-shift-alt-ctrl-8): user.switcher_focus_or_launch("Postico")
