...
class UserActions:
    ...
    def code_state_switch():
        ...
        actions.key('left')
    def code_state_case():  actions.auto_insert('case :')
    
    def code_state_go_to(): actions.auto_insert('')
    ...
    def code_include():         actions.auto_insert('')
    
    def code_include_system():  actions.auto_insert('')
    
    def code_include_local():   actions.auto_insert('')
    
    def code_type_definition(): actions.auto_insert('')
    
    def code_typedef_struct():  actions.auto_insert('')
