...
block comment line <user.text> over: user.code_start_line_with_block_comment(text)
block comment <user.text> over: user.code_comment_block(text)
block comment <user.text>$: user.code_comment_block(text)
(line | inline) block comment <user.text> over: user.code_end_line_with_block_comment(text)
(line | inline) block comment <user.text>$: user.code_end_line_with_block_comment(text)
