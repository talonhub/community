...
block comment line <user.text> over: user.code_block_comment_line(text)
block comment <user.text> over: user.code_comment_block(text)
block comment <user.text>$: user.code_comment_block(text)
(line | inline) block comment <user.text> over: user.code_inline_block_comment(text)
(line | inline) block comment <user.text>$: user.code_inline_block_comment(text)
